...
\begin{frame}{Dataset: Piraeus AIS}
  \begin{itemize}
    ...
    \item Dataset sadrži AIS poruke kreirane tokom aktivnosti brodova u okviru luke Pirej u Grčkoj.
    \item AIS zapisi opisuju kretanje brodova kroz atribute kao što su vreme, identifikator broda, geografska pozicija, brzina, kurs i pravac.
